private["_cyArray","_cyCount","_currentElement","_currentName","_currentPrice","_currendID","_listEntry","_itemInformation","_itemCategory","_itemType","_itemConfig","_index","_itemDisplayName"];
