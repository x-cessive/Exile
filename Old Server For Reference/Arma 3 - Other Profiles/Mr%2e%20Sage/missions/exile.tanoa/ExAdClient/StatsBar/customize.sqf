...
ExAd_SB_Show_KD_Default = true;						//BOOLEAN - Template, show kill death ratio
...
ExAd_SB_Show_ClanCount_Default = true;					//BOOLEAN - Template, show online family members count 
...
ExAd_SB_Allow_ClanCount = 	true;						//BOOLEAN - Allow showing online family members count
