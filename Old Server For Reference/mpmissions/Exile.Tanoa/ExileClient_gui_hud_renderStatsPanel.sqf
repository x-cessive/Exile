...
private["_display","_hunger","_hungerValueControl","_hungerLabelControl","_thirst","_thirstValueControl","_thirstLabelControl","_Cenvironmantvalue","_Fenvironmantvalue","_FbodyTemperature","_health","_healthValueControl","_healthLabelControl","_bodyTemperature","_bodyTemperatureValueControl","_bodyTemperatureLabelControl","_environmentTemperatureValueControl"];
...
if (diag_tickTime - ExileHudStatsRenderedAt >= 0.25) then
{
	...
	_Cenvironmantvalue = [ExileClientEnvironmentTemperature, 1] call ExileClient_util_math_round;
