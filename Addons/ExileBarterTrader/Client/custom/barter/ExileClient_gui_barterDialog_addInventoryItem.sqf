...
["ErrorTitleAndText", ["Trade Updated!", "You removed an item from the your offer!"]] call ExileClient_gui_toaster_addTemplateToast;

lbClear _inventoryListBox;
ExileClientPlayerInventoryItems pushBack _itemClassName;
