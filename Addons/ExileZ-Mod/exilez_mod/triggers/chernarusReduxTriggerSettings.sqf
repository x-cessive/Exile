...
EZM_Trigger_1 = [                 //Main Cities
/* 0  Use this trigger */    True,                    // Self - explanatory
/* 1  Trigger Positions */   EZM_MainCitiesOnly,    // The name of the array used to list all trigger position in the TriggerPositions.sqf file
/* 2  Max Zombies */         10,                    // The maximum number of zombies for that trigger.
/* 3  Activation Delay */    30,                    // The delay before the activation of the trigger.
/* 4  Spawn Delay */         60,                    // The delay between each zombie spawn right after the activation until the Max group size is reached.
/* 5  Respawn Delay */       120,                    // The respawn delay after the max group size was reached
...
EZM_Trigger_2 = [                 //Cities
/* 0  Use this trigger */    True,
/* 1  Trigger Positions */   EZM_Cities,
/* 2  Max Zombies */         8,
