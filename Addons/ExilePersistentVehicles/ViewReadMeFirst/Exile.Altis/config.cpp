...
class CfgExileCustomCode 
{
	...
	*/
	...
	//VEHICLE SERVER - ONLY USE OVERRIDES IF IT DOES NOT WORK OUT OF THE BOX! Set SimpleOverride to 0 in vehicles.pbo serverside first!
	ExileServer_object_vehicle_database_load = "customcode\server\ExileServer_object_vehicle_database_load.sqf";
	ExileServer_system_process_postInit = "customcode\server\ExileServer_system_process_postInit.sqf";
	ExileServer_world_initialize = "customcode\server\ExileServer_world_initialize.sqf";
